<h1 align="center">Hello World 👋, I'm Suhas Kanwar</h1>
...
- Designed and deployed NLP pipelines to extract thematic patterns from Scopus, WOS, and other data sources using transformer models and topic modeling techniques.
- Built a full-stack research analytics tool using **Django**, **PostgreSQL**, and **React** with real-time inference visualization.

### 🌐 Web Development Intern — *USTART, Gurugram*
**November 2024 – May 2025**
- Engineered scalable backend APIs and integrated **PostgreSQL** and **Firebase** for efficient handling of structured and unstructured data.
- Developed core algorithms for location-based driver matching and dynamic pricing using geospatial and rule-based logic.
...
![Hono.js](https://img.shields.io/badge/Hono.js-E36002?style=flat&logo=hono&logoColor=white)
...
- 🥇 **1st Place** — Hack Geek 1.0 Hackathon by Geek Room, hosted at OpsTree Global
- 🥇 **1st Place** — Techsprint 48-Hour Hackathon 2025, Graphic Era, Dehradun
- 🥇 **1st Place** — ACIC Innoverse'36 Hackathon 2025, SGT University
- 🥈 **2nd Place** — Smart India Hackathon (SIH) 2025 Internals
- 🥉 **3rd Place** — HackSmart Hackathon by BatterySmart & AWS
- 🥉 **2nd Runner-up** — Code Kshetra 2.0 (National Hackathon) by Geek Room
- 🏅 **2nd Place** — Creative Robot Designing, Innovation Festival, NSC Delhi (Jan 2018)
- 👨‍💼 **Student-Alumni Relationship Cell** — Tech Team Lead
- 🌐 **College Fest Website** — Team Lead
...
[![LeetCode](https://img.shields.io/badge/LeetCode-FFA116?style=flat&logo=leetcode&logoColor=white)](https://leetcode.com/u/Suhas_Kanwar)
